...
public class WordService {
    ...
    public WordService(SentenceRepository sentenceRepository, DefinitionRepository definitionRepository,
                       WordRepository wordRepository, WordFormRepository wordFormRepository) {
    ...
    @Transactional
    public void saveGeneratedContentToWord(Set<Sentence> sentences, Set<Definition> definitions,  Set<Word> words) {
